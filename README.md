...
![Go](https://github.com/aryehlev/go-json/workflows/Go/badge.svg)
[![GoDoc](https://godoc.org/github.com/aryehlev/go-json?status.svg)](https://pkg.go.dev/github.com/aryehlev/go-json?tab=doc)
...
If you have the API you need, please submit your issue [here](https://github.com/aryehlev/go-json/issues).

# Features

- Drop-in replacement of `encoding/json`
- Fast ( See [Benchmark section](https://github.com/aryehlev/go-json#benchmarks) )
...
```
go get github.com/aryehlev/go-json
```

# How to use

Replace import statement from `encoding/json` to `github.com/aryehlev/go-json`

```
-import "encoding/json"
+import "github.com/aryehlev/go-json"
```
...
[go-json-fuzz](https://github.com/aryehlev/go-json-fuzz) is the repository for fuzzing tests.
If you run the test in this repository and find a bug, please commit to corpus to go-json-fuzz and report the issue to [go-json](https://github.com/aryehlev/go-json/issues).
...
The technique for working with `*reflect.rtype` directly from `go-json` is implemented at [rtype.go](https://github.com/aryehlev/go-json/blob/master/internal/runtime/rtype.go)
...
If you want to know more, please refer to the implementation [here](https://github.com/aryehlev/go-json/blob/master/internal/runtime/type.go#L36-L100)
